...
//        filterChainDefinitionMap.put("/**", "crosAuthc");
        // 如果不设置默认会自动寻找Web工程根目录下的"/login.jsp"页面
        shiroFilterFactoryBean.setLoginUrl("/login");
        // 登录成功后要跳转的链接
//        shiroFilterFactoryBean.setSuccessUrl("/logoutSuccess");

        //未授权界面;
        Map<String, Filter> filterMap=new HashMap<>();
        filterMap.put("crosAuthc",new MyFormAuthenticationFilter(userService));
